    ...
    <div className="information-container">
      ...
      <ul>
        ...
        <li className="formula-li">
          ...
          <span>where σ<sub>x</sub> is the standard deviation of all the domains, and ā and σ<sub>a<sub>i</sub></sub> are the mean and the standard deviation of the size of neighboring domains of i<sup>th</sup> domain, respectively.<span className="asterisk"> *  </span>Because a domain with one or no finite neighbors would have 0 as its σ<sub>a<sub>i</sub></sub> and would then force the coefficient to asymptotically become 0, only domains with more than one finite neighbor are factored into the calculation.</span>
        </li>
        <li>
